...
const WISHES: WishCardProps[] = [
  ...
  },
  {
    ...
    note: "Wishing you a year filled with joy and success!",
  },
  {
    id: 3,
    wisher: "Melat",
    wish: "Cheers to you!",
    note: "Hope your day is as amazing as you are!",
  },
  {
    id: 4,
    wisher: "Bereky",
    wish: "To a great leader!",
    note: "Thanks for all your guidance and support!",
  },
  {
    id: 5,
    wisher: "Etsub",
    wish: "Have a fantastic day!",
    note: "May your special day be filled with laughter and happiness!",
  },
  {
    id: 6,
    wisher: "Bereket K.",
    wish: "Happy Birthday, Mohammed!",
    note: "Wish you endless success, happiness, and blessings ahead!",
  },
  {
    id: 7,
    wisher: "Anonymous",
    wish: "Wishing you the best!",
    note: "May all your birthday wishes come true!",
  },
  {
    id: 8,
    wisher: "Anonymous",
    wish: "Happy Birthday!",
    note: "Enjoy your special day to the fullest!",
  },
  {
    id: 9,
    wisher: "Anonymous",
    wish: "To the coolest boss!",
    note: "Wishing you an awesome birthday and a fantastic year ahead!",
  },
];
